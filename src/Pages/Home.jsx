...
const WORDS = ["Software Developer & Data Analyst","Passionate Technologist", "UI/UX Designer","Sustainability-Driven Innovator"];
...
const SOCIAL_LINKS = [
  ...
  { icon: Mail, link: "mustangmr64@gmail.com"}
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Innovating with purpose, designing for sustainability, delivering with professionalism
                </p>
